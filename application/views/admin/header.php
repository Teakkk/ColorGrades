    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <?php
                //$img = '<img src="'.base_url().'assets/img/logo.png'.'" alt="ColorGrades"/>';
                echo anchor('dashboard','ColorGrades','class="navbar-brand"');
                ?>
            </div>
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><?php echo anchor('login/logout', '<i class="fa fa-sign-out fa-fw"></i> Изход');?></li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                <!-- /.dropdown -->
